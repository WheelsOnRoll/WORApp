...
public class testPage3Fragment extends PageMainFragment {  public testPage3Fragment(){}

    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
            Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        final View view= inflater.inflate(R.layout.fragment_test_page3, container, false);
        ViewPager viewPager = (ViewPager) view.findViewById(R.id.testpage3viewpager);
        if (viewPager != null) {
            setupViewPager(viewPager);
        }
        TabLayout tabLayout = (TabLayout) view.findViewById(R.id.testpage3tabs);
